...
export default function NotFoundPage() {
  return (
    <>
    <Helmet>
      <title>{seoMetadata.notFound.title}</title>
      <meta name="description" content={seoMetadata.notFound.description} />
      <link rel="canonical" href={seoMetadata.notFound.canonical} />
